        ...
        while True:
            ...
            for _ in range(40):
                ...
                if sample:
                    ...
                    if yellow_center is not None:
                        print("found yellow")
                        gii_bluerov.stop_rov(autopilot)  # Stop forward movement
                        sleep(1)
                        return yellow_center, yellow_area, current_distance
                sleep(0.1)
            ...
            for _ in range(70):
                ...
                if sample:
                    ...
                    yellow_center, yellow_area, current_distance = detect_yellow_color(frame)
                    if yellow_center is not None:
                        gii_bluerov.stop_rov(autopilot)  # Stop rotation
                        sleep(1)
                        return yellow_center, yellow_area, current_distance
                sleep(0.1)
        ...
        while True:
            ...
            if sample:
                ...
                if yellow_center is not None:
                    ...
                    print("Mode:", autopilot.mode.name)
                    gii_bluerov.stop_rov(autopilot)
                    yellow_center, yellow_area, current_distance = search_pattern()
                    if yellow_center is not None:
                        distance_control = compute_distance_control(current_distance)
                        # Use x-axis for forward/backward movement
                        gii_bluerov.move_rov(autopilot, "x", "displacement", distance_control)
